...
//  Background Thread for Classifying Frames
    ...
    private void classifyFrame() {
        if (imageClassifier == null || mCamera == null) {
            showToast("Uninitialized Classifier or invalid context");
            return;
        }
        try {
            Bitmap bitmap = Bitmap.createScaledBitmap(currentBitmap,ImageClassifier.DIM_IMG_SIZE_X,ImageClassifier.DIM_IMG_SIZE_Y,false);
