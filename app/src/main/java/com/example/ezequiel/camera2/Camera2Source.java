...
public class Camera2Source {
    ...
    private ImageClassifier imageClassifier = MainActivity.getClassifier();
...
//            else
//                showToast("Uninitialized Context");
            return;
        }
        try {
            Bitmap bitmap =
